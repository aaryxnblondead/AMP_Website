  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="bg-gradient-to-r from-primary-700 to-primary-900 text-white rounded-lg p-8 mb-8">
        <h1 className="text-5xl font-display font-bold mb-4">AMP National Talent Search 2025</h1>
        <p className="text-2xl mb-2">6th Edition</p>
        <p className="text-lg">India's Largest Educational Talent Hunt</p>
      </div>
