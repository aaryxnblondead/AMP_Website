  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl lg:text-4xl font-display font-bold text-primary-700 mb-3 sm:mb-4">Frequently Asked Questions</h1>
        <p className="text-sm sm:text-base lg:text-lg text-neutral-700">Find answers to common questions about AMP and our programs</p>
      </div>

      <div className="bg-white rounded-lg shadow-card p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
        <h2 className="text-xl sm:text-2xl font-display font-bold text-neutral-900 mb-4 sm:mb-6">General Questions</h2>
      ...
      <div className="bg-white rounded-lg shadow-card p-4 sm:p-6 lg:p-8 mb-6 sm:mb-8">
        <h2 className="text-xl sm:text-2xl font-display font-bold text-neutral-900 mb-4 sm:mb-6">NTS Related</h2>
        <div className="space-y-4">
      ...
      <div className="bg-white rounded-lg shadow-card p-4 sm:p-6 lg:p-8">
        <h2 className="text-xl sm:text-2xl font-display font-bold text-neutral-900 mb-4 sm:mb-6">Donations & CSR</h2>
        <div className="space-y-4">
